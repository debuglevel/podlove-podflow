...
class Auphonic_Production_Service_Object implements \ezcWorkflowServiceObject
{
    ...
    public function execute(\ezcWorkflowExecution $execution)
    {
        ...
        $client = new \Guzzle\Http\Client('https://auphonic.com/api/simple',
        ...
        $request = $client->post('productions.json', null,
                        array('preset' => $preset, 'title' => 'megatitle', 'action' => 'start',
                    'input_file' => '@' . $episode_temp_path))->setAuth($username,
                $password);
