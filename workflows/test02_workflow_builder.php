...
class Test02_Workflow_Builder extends Workflow_Builder
{
    ...
    protected function build_process_steps()
    {
        ...
        $this->process_steps['true'] = new \ezcWorkflowNodeAction(array('class' => '\Podlove\Modules\Podflow\Actions\Echo_Service_Object',
            'arguments' => array('message: TRUE')));
        $this->process_steps['false'] = new \ezcWorkflowNodeAction(array('class' => '\Podlove\Modules\Podflow\Actions\Echo_Service_Object',
    ...
    protected function connect_process_steps()
    {
        ...
        $this->process_steps['branch']->addConditionalOutNode(new \ezcWorkflowConditionVariable('choice',
                new \ezcWorkflowConditionIsTrue), $this->process_steps['true']);
        $this->process_steps['branch']->addConditionalOutNode(new \ezcWorkflowConditionVariable('choice',
                new \ezcWorkflowConditionIsFalse),
                $this->process_steps['false']);
