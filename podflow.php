...
class Podflow extends \Podlove\Modules\Base
{
    ...
    public function create_menu()
    {
        ...
        add_submenu_page(
                ...
                /* $menu_slug  */
                'podlove_podflow_settings_handle',
    ...
    private function setup_tables($dbHandler)
    {
        $definedSchema = \ezcDbSchema::createFromFile('array',
                        dirname(__FILE__) . '/lib/zetacomponents/WorkflowDatabaseTiein/tests/workflow.dba');
    ...
    private function get_workflow_execution($workflow_name, $execution_id = null)
    {
        ...
        $execution = new \ezcWorkflowDatabaseExecution($dbHandler,
        ...
        {
            $execution->workflow = $this->get_workflow($workflow_name,
                    $dbHandler);
        }
    ...
    {
        $execution = $this->get_workflow_execution($workflow_definition,
                $execution_id);
